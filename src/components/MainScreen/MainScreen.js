/**
 * Creative Sutan Ibrahim
 */

import { View, Text, StatusBar, TextInput, TouchableOpacity, ScrollView, Image } from "react-native";
import React, { Component } from "react";
import Loader from "./../utilities/Loader";
import { callRemoteMethod } from "../utilities/Services";
import Constants from "./../utilities/Constants";
import { renderIf } from "../utilities/Methods";
import Styles from "./Styles";
import { customAlert } from "./../utilities/Methods";
...
class MainScreen extends Component {
  ...
  state = {
    movieList: [], // list movies Yang akan ditampilkan.
    isLoading: false, //loader .
    searchText: "", // Text Untuk Search.
    noData: false // Saat data Tidak Ada.
  };
  ...
  render() {
    return (
      <View style={{ flex: 1 }}>
        ...
        {renderIf(this.state.noData, <Text style={{ textAlign: "center" }}>Data TIdak Ada .</Text>)}
        {renderIf(
